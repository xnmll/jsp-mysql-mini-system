...
@WebServlet(name = "AddOneTwoAction",urlPatterns = "/addOneTwoAction")
public class AddOneTwoAction extends HttpServlet {
...
//        System.out.println(TimeOut);
        ...
        //输出字符
        JsonObject json = CardDao.addonetwo(CardNumber,CardPassword,Point,TimeOutDate,AddTime);
        writer.print(json);
        writer.flush();
    }

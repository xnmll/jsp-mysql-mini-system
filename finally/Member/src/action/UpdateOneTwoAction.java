...
@WebServlet(name = "UpdateOneTwoAction",urlPatterns = "/updateOneTwoAction")
public class UpdateOneTwoAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JsonObject update = CardDao.updateonetwo(CardID,CardNumber,CardPassword,Point,TimeOut);

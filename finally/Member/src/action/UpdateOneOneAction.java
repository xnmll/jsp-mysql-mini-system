...
@WebServlet(name = "UpdateOneOneAction",urlPatterns = "/updateOneOneAction")
public class UpdateOneOneAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JsonObject update = CardDao.updateoneone(CardID,CardNumber,CardPassword,Point,TimeOut);

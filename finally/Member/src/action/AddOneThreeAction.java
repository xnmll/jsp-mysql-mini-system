...
@WebServlet(name = "AddOneThreeAction",urlPatterns = "/addOneThreeAction")
public class AddOneThreeAction extends HttpServlet {
...
//        System.out.println(TimeOut);
        ...
        //输出字符
        JsonObject json = CardDao.addonethree(CardNumber,CardPassword,Point,TimeOutDate,AddTime);
        writer.print(json);
        writer.flush();
    }
